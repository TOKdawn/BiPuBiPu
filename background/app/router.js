...
module.exports = app => {
    ...
    router.get('/user/likeList/:uid', controller.user.getMyStar); //获取自己喜爱乐谱 page 
    router.get('/user/starList/:uid', controller.user.getMyLike); //获取自己关注 page 
    ...
    router.get('/scoreCollection/:sid', controller.score.addCollectionScore); 
    router.delete('/scoreCollection/:sid', controller.score.deleteCollectionScore); 
    router.post('/dsadasdcxzc',controller.system.userRole)
    ...
    router.delete('/score/:sid', controller.score.deleteScore); 
    router.put('/volume/:vid', controller.volume.editVolume); // 编辑谱册
    router.get('/score/:sid',controller.score.getScoreInfo)
    ...
    router.get('/score/author/:sid',controller.score.getScoreAuthor ); //获取谱册作者
    router.get('/volume/collector/:vid',controller.volume.getVolumeCollector ); //获取谱册作者
    router.get('/score/collector/:sid',controller.score.getScoreCollector ); //获取谱册作者
